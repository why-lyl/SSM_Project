        ...
        <form id="form1" class="layui-form layui-form-pane">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input id="departmentName" onchange="checkDepartment()"  value="" type="text"  name="departmentName" required="" lay-verify="required|repeat"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input  value="" type="text"  name="departmentDesc" required="" lay-verify="required"
                        autocomplete="off" class="layui-input">
                    </div>
                </div>
  ...
  //监听提交
	form.on('submit(add)', function(data){
           ...
           $.ajax({
       		...
       		dataType : "text",
       		url :"departmentController/departmentAdd.ajax",
       		success : function(result) {
       		 //发异步，把数据提交给php
                layer.msg("修改成功",{
             		icon : 1,
